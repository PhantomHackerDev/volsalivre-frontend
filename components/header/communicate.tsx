...
const Communicate:React.FC<CommunicateProps> = ({menu, setToEnter}) => {
    return (
        <>
        ...
        <div className={`${menu === 1 ? "flex" : "hidden"} p-10 flex-col justify-between gap-5`}>
          <button className="flex gap-5 px-5 py-3 focus:border-2 border-purple-400 focus:shadow-inner">
          ...
          <button
            className="mx-16 py-2 text-xl rounded-full bg-orange-50 hover:bg-orange-100 border border-purple-400"
            onClick={() => setToEnter(true)}
          >
            To Enter
          </button>
