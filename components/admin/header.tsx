            ...
            >
                ...
                <div className="hidden md:flex md:flex-row justify-between items-center">
                    <ul className="flex justify-between items-center space-x-1">
                        ...
                        <li className=""><a href={`/admin/${encodeURIComponent('Minha Escola')}`} className="text-orange-500 justify-between items-center  hover:rounded-full hover:bg-gray-300 p-3 md:text-[15px] sm:text-[12px]"><span>Minha Escola</span></a></li>
                        <li className=""><a href={`/admin/${encodeURIComponent('Minhas Ofertas')}`} className="text-orange-500 justify-between items-center  hover:rounded-full hover:bg-gray-300 p-3 md:text-[15px] sm:text-[12px]"><span>Minhas Ofertas</span></a></li>
                        <li className=""><a href={`/admin/${encodeURIComponent('Meus Alunos')}`} className="text-orange-500 justify-between items-center  hover:rounded-full hover:bg-gray-300 p-3 md:text-[15px] sm:text-[12px]"><span>Meus Alunos</span></a></li>
                        <li className=""><a href={`/admin/${encodeURIComponent('Servios')}`} className="text-orange-500 justify-between items-center  hover:rounded-full hover:bg-gray-300 p-3 md:text-[15px] sm:text-[12px]"><span>Servios</span></a></li>
                        <li className="">
                ...
                {/* Drawer Menu */}
                <div className={`fixed top-0 left-0 h-full w-full justify-center bg-slate-200 z-50 transform transition-transform duration-300 ${isOpen ? 'translate-y-[40px]' : '-translate-y-full'}`}>
