    ...
    <div className="flex flex-col gap-10">
      <div className="md:flex bg-purple-600 lg:px-40 px-5 py-5 lg:gap-20 text-white">
        <div className="flex gap-5 items-center">
          ...
          <div className="flex flex-col gap-1">
            <span className="font-semibold">0800 941 9002</span>
      ...
      <div className="lg:flex lg:justify-between items-center lg:px-40 px-10 py-10 bg-slate-200 text-slate-500">
        <div className="flex justify-start gap-10 text-slate-500">
            <a href="" className="rounded-full hover:ring-4 hover:ring-slate-50"><svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 512 512"><path fill="currentColor" fill-rule="evenodd" d="M480 257.35c0-123.7-100.3-224-224-224s-224 100.3-224 224c0 111.8 81.9 204.47 189 221.29V322.12h-56.89v-64.77H221V208c0-56.13 33.45-87.16 84.61-87.16c24.51 0 50.15 4.38 50.15 4.38v55.13H327.5c-27.81 0-36.51 17.26-36.51 35v42h62.12l-9.92 64.77H291v156.54c107.1-16.81 189-109.48 189-221.31"/></svg></a>
